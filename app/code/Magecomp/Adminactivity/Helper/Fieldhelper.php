...
use Magecomp\Adminactivity\Helper\Themehelper;
/**
 * Class Data
 * @package Magecomp\Adminactivity\Helper
 */
class Fieldhelper extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * @var string;
     */
    ...
    /**
     * @var \Magecomp\Adminactivity\Helper\Confighelper
     */
    public $configHelper;

    /**
     * @var \Magecomp\Adminactivity\Helper\Themehelper
     */
    public $themeHelper;
    ...
    public function getEditData($model, $method)
    {
        ...
        if (\Magecomp\Adminactivity\Helper\Data::isWildCardModel($model)) {
            if ($method==self::SYSTEM_METHOD) {
                return $this->configHelper->getEditData($model, $fieldArray);
            } elseif ($method==self::THEME_METHOD) {
                return $this->themeHelper->getEditData($model, $fieldArray);
            }
        }
