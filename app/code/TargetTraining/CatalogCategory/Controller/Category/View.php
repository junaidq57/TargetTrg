...
namespace TargetTraining\CatalogCategory\Controller\Category;
...
class View extends \Magento\Catalog\Controller\Category\View
{
    ...
    {
        parent::__construct(
            $context, $catalogDesign, $catalogSession, $coreRegistry,
            $storeManager, $categoryUrlPathGenerator, $resultPageFactory,
            $resultForwardFactory, $layerResolver, $categoryRepository
        );
    ...
    public function execute()
    {
        ...
        if ($category) {
            ...
            if (!is_null($category->getCourseCategories()) && !$category->getCourseCategories()){
